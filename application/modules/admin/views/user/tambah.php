	...
	<form method="POST" enctype="multipart/form-data">
		<table>
			...
			<tr class="input-form">
				...
				<td>
					<input type="email" name="email" value="<?php echo $this->form->get_temp_data('email');?>">
			...
			<tr class="input-form">
				...
				<td>
					<?php echo form_dropdown('id_role', $role, $this->form->get_temp_data('id_role'),array('id'=>'id_role'));?>
			...
			<tr class="input-form" id="division" style="display:none">
				...
				<td>
					<?php echo form_dropdown('id_division', $budget_spender, $this->form->get_temp_data('id_division'),array('disabled'=>'disabled','id'=>'divisionDD'));?>
