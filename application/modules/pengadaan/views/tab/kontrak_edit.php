	...
	<form method="POST" enctype="multipart/form-data">
		<table>
			<tr class="input-form">
				...
				<td><input type="hidden" name="id_vendor" value="<?php echo $winner['id_winner'];?>">
					<?php echo $winner['winner_name']?>
					<?php echo form_error('id_winner'); ?>
				</td>
			</tr>
			...
			<tr class="input-form">
				...
				<td>
					...
					<input type="text" name="no_sppbj" value="<?php echo ($this->form->get_temp_data('no_sppbj'))?$this->form->get_temp_data('no_sppbj'):$pengadaan['11']['date'];?>">
			...
			<tr class="input-form">
				...
				<td>
					<?php #echo (isset($tanggal_sppbj)) ? default_date($tanggal_sppbj) : 'a';?>
