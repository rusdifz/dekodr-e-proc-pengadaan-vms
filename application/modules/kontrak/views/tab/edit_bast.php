			...
			<form method="POST" enctype="multipart/form-data">
				<table>					
					...
					<tr class="input-form">
						...
						<td>
							<?php 
								$v = array('' => 'Pilih Salah Satu','bast_tahapan' => 'BAST Tahapan', 'bast_final' => 'BAST Final');
								echo form_dropdown('bast_type', $v, ($this->form->get_temp_data('bast_type'))?$this->form->get_temp_data('bast_type'):$bast_type,'');?>
