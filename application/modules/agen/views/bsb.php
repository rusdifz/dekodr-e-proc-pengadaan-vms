...
<a href="<?php echo site_url('agen/formBidang/'.$id_agen);?>" class="btnBlue"><i class="fa fa-plus"></i> Tambah</a>
</div>
			...
			?>
				<tr>
					...
					<td class="actionBlock">
						<a href="<?php echo site_url('agen/formEditBidang/'.$id_agen.'/'.$value['id'])?>" class="editBtn"><i class="fa fa-cog"></i>Edit</a> | 
						<a href="<?php echo site_url('agen/bsb_hapus/'.$id_agen.'/'.$value['id'])?>" class="delBtn"><i class="fa fa-trash"></i>Hapus</a>
					</td>
				</tr>
			<?php 
			}
